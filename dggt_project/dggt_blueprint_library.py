...
class BlueprintLibrary:
    ...
    def __init__(self, data_dir: str = None) -> None:
        ...
        Args:
            data_dir (str): Directory containing blueprint JSON files. If None, uses current directory.
        ...
        with open(f"{data_dir}blueprint_sizes_vehicle.json", "r") as f:
            self.blueprint_sizes_vehicle = json.load(f)
        with open(f"{data_dir}blueprint_sizes_walker.json", "r") as f:
