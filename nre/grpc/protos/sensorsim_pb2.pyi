...
class CameraSpec(_message.Message):
    __slots__ = ["temporary_camera_spec", "ftheta_param", "opencv_pinhole_param", "opencv_fisheye_param", "logical_id", "trajectory_idx", "resolution_h", "resolution_w", "shutter_type", "bivariate_windshield_model_param"]
